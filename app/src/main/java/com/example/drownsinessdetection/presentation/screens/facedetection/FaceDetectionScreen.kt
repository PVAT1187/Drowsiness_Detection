...
fun ScanSurface(navController: NavController) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        CameraView(
            ...
            analyzer =
                FaceDetectionAnalyzer { detectedFaces, detectedDrowsyFaces, width, height ->
                    faces.clear()
                    faces.addAll(detectedFaces)
                    if (detectedDrowsyFaces.isNotEmpty()) {
        ...
        Column(
            ...
            if (openAlertDialog.value) {
                AlertDriverDrowsinessDetected(
                    ...
                    dialogTitle = "Drowsy Faces Detected",
                    dialogText = "Please take necessary actions",
...
fun DrawFaces(
    ...
    Canvas(modifier = Modifier.fillMaxSize()) {
        faces.forEach { face ->
            ...
            val topLeft =
                adjustPoint(PointF(boundingBox.topLeft.x, boundingBox.topLeft.y), imageWidth, imageHeight, screenWidth, screenHeight)
...
@Composable
fun AlertDriverDrowsinessDetected(
